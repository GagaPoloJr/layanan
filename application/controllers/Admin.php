...
class Admin extends MY_Controller
{
    ...
    public function list_data_berbayar()
    {
        ...
        $this->load->database();
        $data['pemohon'] = $this->db->query('select * from pemohonbmkg1')->result();
    ...
    {
        $this->load->database();
        $data['pemohon'] = $this->db->query("select * from pemohonbmkg1 where idpemohon = '$id'")->result();
    ...
    public function konfirmasi($id)
    {
        ...
        $data['coba'] = $this->db->query("select * from pemohonbmkg1 where idpemohon ='$id'")->result();
        $coba = $data['coba'];
    ...
    public function hapus_data($id)
    {
        ...
        $this->modelresponden->delete_data($where, 'pemohonbmkg1');
