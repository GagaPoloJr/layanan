          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="small-box bg-warning">
                ...
                <a href="<?php echo base_url() . 'admin/list_data_berbayar' ?>" class="small-box-footer" style="color: white !important;">More info <i style="color: white;" class="fas fa-arrow-circle-right"></i></a>
              </div>
