...
class modellayanan extends CI_Model
{
    ...
    public function get_pencarian($keyword)
    {
        ...
        $this->db->join('pemohon', 'pelayanan.idpemohon =pemohon.idpemohon ');
    ...
    public function tambah()
    {
        ...
        $this->status = 'no';
        // $this->suratpengantar = $this->_uploadForm();
        $this->db->insert('pemohonbmkg1', $this);
    ...
    public function _uploadForm()
    {
        $config['upload_path']          = './upload/data/';
        $config['allowed_types']        = 'pdf';
        $config['file_name']            = "suratpengantarform-" . $this->idpemohon;
        ...
        // }
        if (!$this->upload->do_upload('PDFform')) {
            $error = array('error' => $this->upload->display_errors());
            $this->session->set_flashdata('error', $error['error']);
            redirect('Page/tambah', 'refresh');
        } else {
            return $this->upload->data("file_name");
        }
