...
d3.queue()
  .defer(d3.json, '/home/iklimjat/layanan.iklimjateng.com/' + "upload/data/jateng-topo.json")
  .defer(d3.csv, '/home/iklimjat/layanan.iklimjateng.com/' + "upload/data/" + document.getElementById("fileinput").value + ".csv")
  .await(ready);
